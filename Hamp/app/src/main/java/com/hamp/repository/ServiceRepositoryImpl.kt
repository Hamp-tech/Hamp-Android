...
class ServiceRepositoryImpl @Inject constructor(
    ...
    override fun loadServices(): Single<List<Service>> {
    ...
    override fun getServicesQuantity() = serviceQuantityDao.getServicesQuantity()

    override fun getServices() = serviceQuantityDao.getServicesQuantityDao()

    override fun saveServiceQuantity(service: Service): Completable {
        return Completable.fromCallable {
            serviceQuantityDao.updateServiceQuantity(ServiceQuantity(service.hampService.id, service.amount))
        }
    }

    override fun deleteBasket(): Completable {
